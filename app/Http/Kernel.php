...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'userVisibilityCheck' => \App\Http\Middleware\UserVisibilityCheck::class,
        ...
        'adminLanguage' => \App\Http\Middleware\CheckAdminLang::class,
        'userLanguage' => \App\Http\Middleware\CheckUserLang::class,
