          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              <div class="col-lg-6 ">
                ...
                @php
                  $allow_theme = ['pet', 'skinflow', 'jewellery'];
                @endphp
                @if (in_array($userBs->theme, $allow_theme))
                  <div class="form-group">
                    <label for="">{{ __('Background Color') }} <span class="text-danger">**</span></label>
                    <input type="text" class="form-control jscolor" value="{{ $social->background_color }}" name="background_color">
