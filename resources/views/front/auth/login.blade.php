...
<head>
  ...
  <!-- Title -->
  <title>Monarch - Furniture | Admin</title>
  <!-- Favicon -->
  <link rel="icon" href="https://store.seabluehost.com/assets/front/img/user/1821bcc376856222be9760fccb34663675ea0dd0.png">
...
<body>
  ...
  @endif
    ...
    <!-- Page Title Start-->
     <div class="page-title-area" style="background-image:url('https://store.seabluehost.com/assets/front/img/user/ce7341c25a0bf2f64ba873879d588b0003ac3cbd.png ')">
      <div class="container">
        <div class="row">
          <div class="col-lg-10">
            <div class="content">
              <h2 class="text-white">Admin Login</h1>
            </div>
          </div>
