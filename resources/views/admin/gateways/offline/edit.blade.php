  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm2" action="{{ route('admin.gateway.offline.update') }}" method="POST">
          @csrf
      ...
      <div class="modal-footer">
        ...
        <button id="updateBtn2" type="button" class="btn btn-primary">{{ __('Save Changes') }}</button>
      </div>
    </div>
  </div>
</div>
