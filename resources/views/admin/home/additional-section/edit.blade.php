        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 m-auto">
              ...
              <form id="pageForm" action="{{ route('admin.additional_section.update', $section->id) }}" method="POST">
                @csrf
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group p-0">
                      ...
                      <select name="possition" class="form-control select2">
                        ...
                        <option @selected($section->possition == 'hero_section') value="hero_section">{{ __('After Hero Section') }}</option>
                        <option @selected($section->possition == 'partner_section') value="partner_section">{{ __('After Partner Section') }}
                        </option>
                        <option @selected($section->possition == 'work_process_section') value="work_process_section">
                          {{ __('After Work Process Section') }}</option>
                        <option @selected($section->possition == 'template_section') value="template_section">
                          {{ __('After Featured Template Section') }}</option>
                        <option @selected($section->possition == 'features_section') value="features_section">{{ __('After Features Section') }}
                        </option>
                        <option @selected($section->possition == 'pricing_section') value="pricing_section">{{ __('After Pricing Section') }}
                        </option>
                        <option @selected($section->possition == 'featured_shop_section') value="featured_shop_section">
                          {{ __('After Featured Shop Section') }}</option>
