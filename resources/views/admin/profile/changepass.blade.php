              ...
              <div class="col-lg-6 m-auto">
                ...
                <div class="form-body">
                  <div class="form-group">
                    ...
                    <div class="">
                      <input class="form-control" name="old_password"
                        placeholder="{{ __('Enter Your Current Password') }}" type="password">
                  ...
                  <div class="form-group">
                    ...
                    <div class="">
                      <input class="form-control" name="password" placeholder="{{ __('Enter New Password') }}"
                        type="password">
                  ...
                  <div class="form-group">
                    ...
                    <div class="">
                      <input class="form-control" name="password_confirmation"
                        placeholder="{{ __('Enter New Password Again') }}" type="password">
                    </div>
                  </div>
                </div>
              </div>
