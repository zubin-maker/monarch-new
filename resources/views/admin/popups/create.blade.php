          ...
          <div class="row">
            ...
            <div class="col-lg-3">
              <a class="btn btn-primary float-right btn-sm"
                href="{{ route('admin.popup.index', ['language' => @$default->code]) }}">{{ __('All Popups') }}</a>
            </div>
          </div>
        </div>
                ...
                @if ($type == 2 || $type == 3 || $type == 6)
                  ...
                  <div class="form-group">
                    <div class="col-12 mb-2 pl-0">
                      <label for="image"><strong>{{ __('Background Image') }}<span class="text-danger">**</span></strong></label>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control ltr flatpickr" name="end_time" value=""
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control ltr" name="background_opacity" value=""
                          placeholder="{{ __('Enter Opacity Value') }}">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control jscolor ltr" name="button_color" value="451d53"
                          placeholder="{{ __('Enter Button Color') }}">
