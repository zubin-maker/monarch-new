          ...
          <div class="row">
            ...
            <div class="col-lg-5 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="{{ route('admin.about_us.additional_section.bulkdelete') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm  mt-1 mr-1"
                              href="{{ route('admin.about_us.additional_section.edit', ['id' => $sectoin->id]) }}">
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.about_us.additional_section.delete', ['id' => $sectoin->id]) }}"
                              method="post">
                              @csrf
